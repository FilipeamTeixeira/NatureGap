-- Revert any broad is_admin() bypass and limit postgres-role access to pipeline
-- dataset import/promote only. Moderation and other admin gates stay unchanged.
...
create or replace function public.can_manage_pipeline_datasets()
returns boolean
language sql
stable
security definer
...
grant execute on function public.can_manage_pipeline_datasets() to authenticated;
