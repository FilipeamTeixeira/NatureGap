...
export function statsProperties(stats: ParkStats | undefined) {
  return {
    ...
    trafficExposure: finiteNumber(stats?.trafficExposure),
...
export function renderCellProperties(properties: maplibregl.GeoJSONFeature['properties']): RenderCellProperties | null {
  ...
  return {
    ...
    trafficExposure: properties.trafficExposure == null ? null : Number(properties.trafficExposure),
    rankStability: properties.rankStability == null ? null : Number(properties.rankStability),
